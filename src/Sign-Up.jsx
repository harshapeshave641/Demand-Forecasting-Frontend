  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row font-poppins bg-white">
      ...
      <div className="w-full md:w-1/2 p-8 md:p-12 lg:p-16 flex flex-col justify-center">
        ...
        <p className="text-gray-600 mb-8">Join thousands of organizations managing their operations</p>
      ...
      <div className="hidden md:block md:w-1/2 bg-gray-100 relative">
        <div 
          ...
          style={{ 
            backgroundImage: 'linear-gradient(rgba(5, 150, 105, 0.8), rgba(5, 150, 105, 0.8)), url("")',
